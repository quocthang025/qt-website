...
Route::controller(AuthController::class)->group(function () {
    ...
    Route::post('logout', 'logout');   // ✅ Đổi thành POST
...
Route::controller(AdminController::class)->prefix('admin')->group(function () {
    ...
    Route::post('candidates/update/{id}', 'updateCandidate');
    Route::post('candidates/delete/{id}', 'deleteCandidate');
    Route::get('employers', 'getAllEmployers');
    Route::post('employers/create', 'createEmployer');
    Route::post('employers/update/{id}', 'updateEmployer');
    Route::post('employers/delete/{id}', 'deleteEmployer');
});
