...
--
-- Host: localhost:3306
-- Generation Time: Mar 18, 2025 at 02:05 PM
...
INSERT INTO `contacts` (`id`, `title`, `content`, `rate`, `created_at`, `updated_at`) VALUES
(1, 'Công cụ tạo CV', 'q', 1, '2025-03-17 16:42:33', '2025-03-17 16:42:33'),
(2, 'Công cụ tìm kiếm', 'ok', 4, '2025-03-17 16:44:32', '2025-03-17 16:44:32'),
(3, 'Tính năng/Giao diện trang web', 'ok không', 5, '2025-03-18 13:02:02', '2025-03-18 13:02:02');
...
CREATE TABLE `job_applying` (
  `job_id` bigint(20) UNSIGNED NOT NULL,
  `candidate_id` bigint(20) UNSIGNED NOT NULL,
  `cv_link` text COLLATE utf8mb4_unicode_ci,
...
(31, '2025_03_17_233536_create_contacts_table', 3);
...
CREATE TABLE `resumes` (
  ...
  `cv_link` text COLLATE utf8mb4_unicode_ci,
  `parts_order` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_bin,
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
(6, 'admin@gmail.com', NULL, '$2a$12$kEPorrugnn3pdJ4Oi9fVDen5uNT8J8CUTjHkNQCyojza9sFpA/vIO', NULL, 0, 1, NULL, NULL),
(7, 'company1@gmail.com', NULL, '$2a$12$GpEoGnivZ8iyLMk0FxIX9..zQS.hlPNNECmLStPbywTLgU4twCuku', NULL, 2, 1, NULL, NULL),
